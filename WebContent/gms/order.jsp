...
<%
   ...
   int totalAmount = NumberUtils.stringToNumber(request.getParameter("totalAmount"));
                     ...
                     <div class="tab-content">
                        <div id="old-loc" class="tab-pane fade in active">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                 <input id="payment-point" class="" type="text" value="" name="usepoint" onkeyup="alterPointByKeyboard(event);changePointBox();changeTotalBox();">
                              </div>
                              <div class="col-sm-5" style="left: 94px;">
                                 <button id="use-all-point" type="button" class="btn btn-default btn-xs"  onclick="useAllPoint()">모두사용</button>
                  ...
                  <div class="col-sm-6">
                     <div class="form-group">
                        <div id="order-prod-info">
                           <div>
                              <h3>주문상품 정보/ 총 <%=cartNos.length %>개</h3>
                           </div>
                           <div class="detail-prod-area" >
                              <div class="row" >
                                 ...
                                 %>
                                 <div class="col-sm-5">
                                    <img alt="" src="<%=cart.getItem().getImagePath() %>"   class="img-rounded" style="width: 90%; ">
                                    <br>
                                 </div>
                                 <div class="col-sm-7">
                                    <h6><%=cart.getItem().getBrand() %></h6>
                                 
                                    <span><strong>옥스포드</strong></span>            
                                    <span style="color: #ff4800;"><%=cart.getItem().getDiscountRate() %>%</span> 
                                    <span style="color: #ff4800;" class="comma"><%=cart.getItem().getDiscountPrice() %></span><span>원</span>
                                     <span style="color: #686868">[COLOR:SIZE]<%=cart.getItemOption().getColor() %>:FREE</span>
                                     <span>　　수량:<%=cart.getAmount() %></span>
                                     <input type="hidden" name="cartno" value="<%=cart.getNo()%>">
                                     <input type="hidden" name ="cartamount" value="<%=cart.getAmount() %>">
                                      <br><br><br><br><br>
                                 </div>
                                 <% 
                                    } 
